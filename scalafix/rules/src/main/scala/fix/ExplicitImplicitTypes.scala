...
// begin inlining `import fix.impl.CompilerTypePrinter`
...
// end inlining `import fix.impl.CompilerTypePrinter`
// begin inlining `import fix.impl.PatchEmptyBody`
...
// end inlining `import fix.impl.PatchEmptyBody`
